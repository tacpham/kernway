...
Thymeleaf-inspired server-side template engine. Attribute-based syntax. Auto-escape XSS.
...
| `kw:authorize` role check | ✅ Fail-closed | Render empty if no principal is present |
